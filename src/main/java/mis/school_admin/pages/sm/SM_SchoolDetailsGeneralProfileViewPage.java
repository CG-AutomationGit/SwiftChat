...
public class SM_SchoolDetailsGeneralProfileViewPage extends MIS_Base {
    ...
    public boolean isUDISECodeDisplayed() { return udiseCode.isDisplayed(); }
    public boolean isSchoolNameDisplayed() { return schoolName.isDisplayed(); }
    public boolean isDistrictNameDisplayed() { return districtName.isDisplayed(); }
    public boolean isBlockNameDisplayed() { return blockName.isDisplayed(); }
    public boolean isSchoolLocationTypeDisplayed() { return schoolLocationType.isDisplayed(); }
    public boolean isClusterResourceCentreDisplayed() { return clusterResourceCentre.isDisplayed(); }
    public boolean isAssemblyConstituencyCodeDisplayed() { return assemblyConstituencyCode.isDisplayed(); }
    public boolean isParliamentaryConstituencyCodeDisplayed() { return parliamentaryConstituencyCode.isDisplayed(); }
    public boolean isSchoolManagementCodeDisplayed() { return schoolManagementCode.isDisplayed(); }
    public boolean isNodalMinistryDisplayed() { return nodalMinistry.isDisplayed(); }
    public boolean isSchoolCategoryCodeDisplayed() { return schoolCategoryCode.isDisplayed(); }
    public boolean isLowestClassDisplayed() { return lowestClass.isDisplayed(); }
    public boolean isHighestClassDisplayed() { return highestClass.isDisplayed(); }
    public boolean isPrePrimaryAttachedDisplayed() { return prePrimaryAttached.isDisplayed(); }
    public boolean isNumClassesPrePrimaryDisplayed() { return numClassesPrePrimary.isDisplayed(); }
    public boolean isTypeOfSchoolDisplayed() { return typeOfSchool.isDisplayed(); }
    public boolean isSchoolStatusDisplayed() { return schoolStatus.isDisplayed(); }
    public boolean isSessionStartDateDisplayed() { return sessionStartDate.isDisplayed(); }
    public boolean isSessionEndDateDisplayed() { return sessionEndDate.isDisplayed(); }
    public boolean isStreamArtsDisplayed() { return streamArts.isDisplayed(); }
    public boolean isStreamVocationalDisplayed() { return streamVocational.isDisplayed(); }
    public boolean isStreamScienceDisplayed() { return streamScience.isDisplayed(); }
    public boolean isStreamCommerceDisplayed() { return streamCommerce.isDisplayed(); }
    public boolean isStreamOthersDisplayed() { return streamOthers.isDisplayed(); }


    @FindBy(xpath = "//input[@id='schoolSearch']")
    WebElement searchField;

    @FindBy(xpath = "//button[@id='searchBtn']")
    WebElement searchButton;

    public void searchBySchoolCodeOrName(String searchText) {
