...
public class SM_SchoolDetailsLocationDetailsViewPage extends MIS_Base {
    ...
    public boolean isLocationTypeEditable(){
        return locationType.isEnabled();
    }

    public boolean isCrcEditable(){
        return crc.isEnabled();
    }
    ...
    public boolean isNodalMinistryDeptEditable(){
        return nodalMinistryDept.isEnabled();
    }
    ...
    public boolean isPrePrimarySectionEditable(){
        return prePrimarySection.isEnabled();
    }

    public boolean isGradesInPrePrimarySectionEditable(){
        return gradesInPrePrimarySection.isEnabled();
    }
    ...
    private WebElement schoolIdElement;
    private WebElement schoolNameElement;

    public boolean searchRecordBySchoolIdAndName(String schoolId, String schoolName) {
        try {
            schoolIdElement = chromeDriver.findElement(By.xpath("//table/tbody/tr/td[3][text()='" + schoolId + "']"));
            schoolNameElement = chromeDriver.findElement(By.xpath("//table/tbody/tr/td[4][text()='" + schoolName + "']"));

            return schoolIdElement != null && schoolNameElement != null;
    ...
    @FindBy(xpath = "//input[@placeholder='Search by School Code or Name']")
