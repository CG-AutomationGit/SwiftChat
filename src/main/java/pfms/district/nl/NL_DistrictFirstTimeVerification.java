package pfms.district.nl;

import org.openqa.selenium.chrome.ChromeDriver;
import pfms.base.PFMSBase;

public class NL_DistrictFirstTimeVerification extends PFMSBase {

    public NL_DistrictFirstTimeVerification(ChromeDriver chromeDriver){
        super(chromeDriver);
    }
